...
export default function Poster() {
  return (
    <>
      <section
        className={`relative bg-transparent md:bg-[#F5C347] md:dark:bg-yellow-600  h-max  md:h-[45vh] lg:h-[56vh] w-screen flex flex-col md:flex-row items-center md:justify-between md:pl-14 md:mt-[5vh] mt-[6vh] lg:mt-[4vh] lg:pl-32 ${merriweather.className} overfolw-clip z-0 `}>
