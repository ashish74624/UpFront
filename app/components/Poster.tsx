...
export default function Poster() {
  return (
    <>
      <section
        className={`relative bg-transparent md:bg-[#F5C347] h-max  md:h-[45vh] lg:h-[56vh] w-screen flex flex-col md:flex-row items-center md:justify-between md:pl-14 md:mt-[5vh] mt-[6vh] lg:mt-[4vh] lg:pl-32 ${merriweather.className} overfolw-clip z-0 `}>
        <div className='pt-4 md:pb-0 pb-7 md:pt-0 space-y-8 md:space-y-10 md:px-0 px-4 md:bg-transparent md:w-max w-screen  bg-[#F5C347]'>
